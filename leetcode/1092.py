...
A string is a subsequence of string t if deleting some number of characters from t (possibly 0) results in the string s.
...
def shortestCommonSupersequence(self, str1: str, str2: str) -> str:
    ...
    m, n = len(str1), len(str2)                                     # Obtain string lengths
    dp = [[0] * (n + 1) for _ in range(m + 1)]                      # LoL to track the DP
    ...
    # Step 2: Construct the shortest common super-sequence
    ...
    # Reverse the result to get the final super-sequence
